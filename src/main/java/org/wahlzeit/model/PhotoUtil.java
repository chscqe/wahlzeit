...
public class PhotoUtil {
	 ...
	 * @methodtype creation
	 */
	public static WindowPhoto createPhoto(String filename, PhotoId id, Image uploadedImage) throws Exception {
		WindowPhoto result = PhotoFactory.getInstance().createPhoto(id);
